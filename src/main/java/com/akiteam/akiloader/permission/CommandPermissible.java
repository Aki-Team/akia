package com.akiteam.akiloader.permission;
 ...
 * <p>
 * 用在 {@link com.akiteam.akiloader.command.CommandRegistry} 的命令执行前校验：
 * 玩家来源按真实 OP 身份判断，非玩家来源（控制台、命令方块、函数）一律视为 OP。
 * <p>
 * 由于 AkiLoader 暂未接入权限插件，{@link #hasPermission(String)} 退化为按 OP 身份判断。
 */
