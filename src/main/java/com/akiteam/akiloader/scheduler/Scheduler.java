package com.akiteam.akiloader.scheduler;
...
/**
 * AkiLoader 的调度器（参考 Paper {@code BukkitScheduler} 的设计思路）。
 * <p>
 * 提供两类执行环境：
 * <ul>
 ...
 * <p>
 * 本类为全局单例 {@link #INSTANCE}，由 {@code AkiLoader} 在每游戏刻注册的
...
public class Scheduler {
    ...
    private final ScheduledExecutorService asyncExecutor = Executors.newScheduledThreadPool(
            2, r -> {
                Thread t = new Thread(r, "AkiLoader-Async");
                t.setDaemon(true);
                return t;
            });
