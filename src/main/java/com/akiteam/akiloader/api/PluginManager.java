 ...
 * 具体实现在 {@code com.akiteam.akiloader.loader} 包中完成（见后续步骤）。
 */
public interface PluginManager {
     ...
     */
    java.util.List<com.akiteam.akiloader.diag.PluginDiagnostic> getDiagnostics();
     ...
     */
    com.akiteam.akiloader.diag.PluginDiagnostic getDiagnostic(String pluginName);
     ...
     * @return 诊断报告
     */
    com.akiteam.akiloader.diag.DumpReport getDumpReport();
